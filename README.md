...
HPE OneView Go library extends support of the SDK to OneView REST API version 3200 (OneView v6.30)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v6.3.0-OV6.3
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v6.3.0-OV6.3 /bin/sh
```
...
```
Note: Currently this SDK supports OneView API 3200 minimally, where we can test OneView API 3200 version with this SDK. If API version is not provided then appliance's API version will be used. If API version used is not supported then error will be thrown.
