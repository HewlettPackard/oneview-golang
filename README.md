...
HPE OneView Go library extends support of the SDK to OneView REST API version 5400 (OneView v8.40)
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v8.4.0-OV8.4 /bin/sh
```
...
Learn more about HPE OneView at [hpe.com/info/oneview](https://hpe.com/info/oneview)| [![Build status](https://github.com/HewlettPackard/oneview-golang/actions/workflows/run_tests/badge.svg)](https://github.com/HewlettPackard/oneview-golang/actions/runs/5321317725) 
