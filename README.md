...
HPE OneView Go library extends support of the SDK to OneView REST API version 8600 (OneView v11.30)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v11.3.0-OV11.3
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v11.3.0-OV11.3 /bin/sh
```
