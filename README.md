...
HPE OneView Go library extends support of the SDK to OneView REST API version 8800 (OneView v11.40)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v11.4.0-OV11.4
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v11.4.0-OV11.4 /bin/sh
```
