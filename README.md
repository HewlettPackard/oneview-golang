...
HPE OneView Go library extends support of the SDK to OneView REST API version 7600 (OneView v10.00)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v10.0.0-OV10.0
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v10.0.0-OV10.0 /bin/sh
```
