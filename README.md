...
HPE OneView Go library extends support of the SDK to OneView REST API version 7200 (OneView v9.30)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v9.3.0-OV9.3
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v9.3.0-OV9.3 /bin/sh
```
