...
HPE OneView Go library extends support of the SDK to OneView REST API version 5000 (OneView v8.20)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v8.2.0-OV8.2
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v8.2.0-OV8.2 /bin/sh
```
...
```
Note: Currently this SDK supports OneView API 5000 minimally, where we can test OneView API 5000 version with this SDK. If API version is not provided then appliance's API version will be used. If API version used is not supported then error will be thrown.
