...
HPE OneView Go library extends support of the SDK to OneView REST API version 8200 (OneView v11.20)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v11.2.0-OV11.2
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v11.2.0-OV11.2 /bin/sh
```
