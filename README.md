...
HPE OneView Go library extends support of the SDK to OneView REST API version 5600 (OneView v8.50)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v8.5.0-OV8.5
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v8.5.0-OV8.5 /bin/sh
```
