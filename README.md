...
HPE OneView Go library extends support of the SDK to OneView REST API version 8200 (OneView v11.00)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v11.0.0-OV11.0
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v11.0.0-OV11.0 /bin/sh
```
