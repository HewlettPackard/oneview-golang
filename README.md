...
HPE OneView Go library extends support of the SDK to OneView REST API version 6400 (OneView v8.90)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v8.9.0-OV8.9
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v8.9.0-OV8.9 /bin/sh
```
