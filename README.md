...
HPE OneView Go library extends support of the SDK to OneView REST API version 8000 (OneView v10.20)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v10.2.0-OV10.2
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v10.2.0-OV10.2 /bin/sh
```
