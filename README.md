...
HPE OneView Go library extends support of the SDK to OneView REST API version 7400 (OneView v9.40)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v9.4.0-OV9.4
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v9.4.0-OV9.4 /bin/sh
```
