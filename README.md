...
HPE OneView Go library extends support of the SDK to OneView REST API version 7600 (OneView v10.10)
...
$ docker pull hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v10.1.0-OV10.1
...
$ docker run -it hewlettpackardenterprise/hpe-oneview-sdk-for-golang:v10.1.0-OV10.1 /bin/sh
```
