...
type Connection struct {
  ...
  NetworkURI        Nstring     `json:"networkUri,omitempty"`        // "networkUri": "/rest/ethernet-networks/cc3088c1-605b-4e99-8084-457f3be3a368",
  ...
  MAC               Nstring     `json:"mac,omitempty"`               // "mac": "34:64:A9:BB:E6:98",
  ...
  Boot              BootOption  `json:"boot,omitempty"`
}
